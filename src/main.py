import argparse
from globals import PROJECT_ID, DATASET_NAME, A1_TABLE_ID, A2_TABLE_ID, A3_TABLE_ID, DISTRESS_CALL_LATITTUDE, DISTRESS_CALL_LONGITUDE
...
if __name__ == "__main__":
	...
	if args.writer:
		...
		gq.write_nearest_viable_port_from_distress_call(DISTRESS_CALL_LATITTUDE, DISTRESS_CALL_LONGITUDE, '%s.%s.%s' % (PROJECT_ID, DATASET_NAME, A3_TABLE_ID))
	gq.read_result_1()
	gq.read_result_2()
	gq.read_result_3()